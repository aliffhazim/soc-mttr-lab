...
- **What I built:** A live, two-machine attack simulation with a custom detection rule inside Wazuh, a SIEM (Security Information and Event Management platform), mapped to [MITRE ATT&CK T1110.004](https://attack.mitre.org/techniques/T1110/004/), engineered to automatically measure response time.
